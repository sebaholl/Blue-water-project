      ...
      <div class="mx-auto grid max-w-7xl overflow-hidden bg-white shadow-xl lg:grid-cols-[1.35fr_0.65fr]">
        ...
        <div class="p-5 sm:p-8 lg:p-14">
          ...
          <div class="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <button
              ...
              :class="selectedCategory === category
                ? 'border-bws-blue bg-bws-blue text-white'
                : 'border-gray-300 bg-white text-black hover:border-bws-blue hover:text-bws-blue'"
            ...
            >
              <div class="flex items-center justify-between gap-4">
                <p
                  ...
                  :class="currentStep === index ? 'text-bws-blue' : 'text-black'"
                >
                  STEP {{ index + 1 }}
                </p>
              ...
              <div class="mt-3 h-[3px] bg-gray-300">
                <div
                  class="h-full bg-bws-blue transition-all duration-500"
          ...
          <form class="mt-10" @submit.prevent="submitForm">
            ...
            <div class="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <button
                type="button"
                class="h-12 px-6 text-sm font-black uppercase tracking-wide text-gray-500 transition hover:text-bws-blue disabled:cursor-not-allowed disabled:opacity-40"
              ...
              <button
                ...
                type="button"
                class="h-12 bg-bws-blue px-6 text-sm font-black uppercase tracking-wide text-white transition hover:-translate-y-1 hover:bg-blue-900"
                @click="goNext"
              >
                Next step →
              </button>
              ...
              <button
                ...
                class="h-12 bg-bws-blue px-6 text-sm font-black uppercase tracking-wide text-white transition hover:-translate-y-1 hover:bg-blue-900 disabled:cursor-not-allowed disabled:opacity-60"
              >
        ...
        <aside class="flex flex-col justify-between bg-gray-200 p-6 sm:p-8 lg:p-14">
          <div>
            ...
            <h2 class="mt-3 text-3xl font-black text-bws-blue">
              {{ selectedCategory }}
            </h2>
          ...
          <div class="mt-12">
            ...
            <div class="mt-8 flex gap-3">
              <span class="h-4 w-4 rounded-full bg-bws-blue"></span>
    ...
    return () =>
      h('div', [
        h('label', { class: 'mb-2 block text-sm font-bold text-gray-700' }, [
          props.label,
          props.required ? h('span', { class: 'ml-1 text-bws-blue' }, '*') : null,
        ]),
        h('input', {
          ...
          class:
            'h-12 w-full border border-gray-300 px-4 text-base outline-none transition focus:border-bws-blue focus:shadow-[0_0_0_3px_rgba(0,0,171,0.12)]',
