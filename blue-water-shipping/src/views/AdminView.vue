      ...
      <div class="bg-white p-5 shadow sm:p-6">
        ...
        <div class="mt-6 space-y-4">
          <article
            ...
            class="border border-gray-200 p-4 transition hover:border-bw-blue hover:shadow-md sm:p-5"
          >
            <div class="flex flex-col justify-between gap-4 md:flex-row md:items-center">
              ...
              <div class="flex flex-col items-start gap-3 md:items-end">
                <select
                  ...
                  class="h-12 w-full border border-gray-300 px-4 text-sm font-bold outline-none transition focus:border-bw-blue focus:shadow-[0_0_0_3px_rgba(0,0,171,0.12)] sm:w-auto"
